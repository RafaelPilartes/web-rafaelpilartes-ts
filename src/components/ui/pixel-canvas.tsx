 ...
 * out on leave. Hover is tracked on the parent element so the canvas never
 * blocks pointer events on the content above it.
 * -------------------------------------------------------------------------- */
...
export function PixelCanvas({ colors, gap = 5, speed = 30 }: PixelCanvasProps) {
  ...
  useEffect(() => {
    ...
    // itself never blocks pointer events on the content above it.
