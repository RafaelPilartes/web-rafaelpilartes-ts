...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="flex h-full w-full flex-col items-center justify-center overflow-hidden bg-transparent"
      ref={containerRef}
      onClick={handleContainerClick}
    >
      <div className="relative flex h-full w-full max-w-4xl items-center justify-center">
        <div
          className="absolute flex h-full w-full items-center justify-center py-20"
          ref={orbitRef}
          style={{
            perspective: '1000px',
        ...
        >
          <div className="absolute z-10 flex h-16 w-16 animate-pulse items-center justify-center rounded-full bg-gradient-to-br from-accent via-[#ff6a5e] to-primary">
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 border-t border-white/10 pt-3">
                        ...
                        <div className="h-1 w-full overflow-hidden rounded-full bg-white/10">
                          <div
                            className="h-full bg-gradient-to-r from-accent to-[#ff6a5e]"
