...
export const mockProjects: ProjectEntity[] = [
  new ProjectEntity({
    ...
    description: {
      raw: '',
      text: 'Descrição completa do projecto ToquePlay...'
    },
  ...
  new ProjectEntity({
    ...
    description: {
      raw: '',
      text: 'Descrição completa do projecto Gusmapis...'
    },
  ...
  new ProjectEntity({
    ...
    description: {
      raw: '',
      text: 'Descrição completa do projecto Kandengue Atrevido...'
    },
  ...
  new ProjectEntity({
    ...
    description: {
      raw: '',
      text: 'Descrição completa do projecto Grace Minds...'
    },
  ...
  new ProjectEntity({
    ...
    description: {
      raw: '',
      text: 'Descrição completa do projecto Dunamis Brand...'
    },
  ...
  new ProjectEntity({
    ...
    description: {
      raw: '',
      text: 'Descrição completa do projecto Tchossy App...'
    },
