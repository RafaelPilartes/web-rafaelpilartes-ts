...
export const ButtonCenterHover = ({
  ...
  return (
    <button
      className={cn(
        'relative w-full py-3 px-4 rounded-md flex flex-row justify-center items-center gap-2 overflow-hidden bg-primary-200 border border-primary-200 text-white shadow-md transition-all duration-200 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:m-auto before:h-8 before:w-0 before:rounded-md before:bg-primary-400 before:duration-300 before:ease-out hover:shadow-primary-200 hover:before:h-[80%] hover:before:w-[94%] hover:before:opacity-80 disabled:opacity-50 active:scale-95',
        className
      )}
      {...props}
    >
      {/* 'py-3 px-4 rounded-lg flex justify-center items-center gap-2 bg-primary-200 text-white hover:bg-white hover:text-primary-200 transition-all  duration-400 disabled:opacity-50 active:scale-95', */}
...
export const ButtonCenterHoverReverse = ({
  ...
  return (
    <button
      className={cn(
        'relative w-full py-3 px-4 rounded-md flex flex-row justify-center items-center gap-2 overflow-hidden border border-primary-200 text-white shadow-md transition-all duration-300 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:m-auto before:h-[100%] before:w-[100%] before:rounded-md before:bg-primary-200 before:duration-300 before:ease-out hover:text-primary-200 hover:shadow-primary-200 hover:before:h-0 hover:before:w-0 hover:before:opacity-80 disabled:opacity-50 active:scale-95',
        className
      )}
      {...props}
    >
      {/* 'py-3 px-4 rounded-lg flex justify-center items-center gap-2 bg-accent text-white hover:bg-white hover:text-accent transition-all  duration-400 disabled:opacity-50 active:scale-95', */}
      <span className="relative flex flex-row justify-center items-center gap-2 z-[2]">
        {children}
      </span>
    </button>
...
export const ShineLight = ({ children, className, ...props }: ButtonProps) => {
  return (
    <button
      {...props}
      className="before:ease w-full rounded-md before:rounded-md relative h-12 px-4 overflow-hidden border border-primary-200 bg-primary-200 text-white shadow-md transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:shadow-primary-200 hover:before:-translate-x-[40rem] active:scale-95"
    >
      <span className="relative flex flex-row justify-center items-center gap-2 z-[2]">
        {children}
      </span>
...
/* LeftToRightSimple */
export const LeftToRightSimple = ({
  children,
  className,
  ...props
}: ButtonProps) => {
  return (
    <button
      {...props}
      className="text-primary hover:before:bg-primary-200 relative h-[50px] w-full overflow-hidden border border-gray-200 dark:border-gray-800/60 bg-white dark:bg-baseDarkGray px-3 text-gray-500 transition-all before:absolute rounded-md before:rounded-md before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-primary-200 before:transition-all before:duration-200 hover:text-white hover:before:left-0 hover:before:w-full active:scale-95"
    >
      <span className="relative flex flex-row justify-center items-center gap-2 z-[2]">
        {children}
      </span>
